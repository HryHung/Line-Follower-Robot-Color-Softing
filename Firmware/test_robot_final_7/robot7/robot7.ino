...
*/
/*
float redCalib[3]  = {55.5, 25.8, 19.3};
float blueCalib[3] = {46.0, 55.5, 47.9};
float unkCalib[3]  = {38.9, 34.0, 25.5};
int cargo_color = 0;
*/
float redCalib[3]  = {126.0, 36.4, 35.2};
float blueCalib[3] = {25.0, 29.0, 29.3};
float unkCalib[3]  = {154.1, 155.5, 157.1};
  ...
  switch(currentState){
    ...
    case WAIT_LOADING:{
      ...
      if(colorStart>0 && now-colorStart>=3000){
        setMotors(500,550);
        if(colorStart>0 && now-colorStart>=3200){
